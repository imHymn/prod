...
data.forEach(item => {
  ...
  row.innerHTML = `
   ...
   <td><button id="timein-${item.material_no}">TIME IN</button></td>
  ...
  if (event.target.id && event.target.id.startsWith('timein-')) {
    const materialNo = event.target.id.replace('timein-', '');
