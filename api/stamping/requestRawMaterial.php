...
// echo "material_no: " . var_export($material_no, true) . "\n";
// echo "component_name: " . var_export($component_name, true) . "\n";
// echo "usage: " . var_export($usage, true) . "\n";
// echo "quantity: " . var_export($quantity, true) . "\n";
// echo "process_quantity: " . var_export($process_quantity, true) . "\n";
