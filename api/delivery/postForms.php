...
$sql = "SELECT lot_no FROM delivery_form_new WHERE model_name = :model_name ORDER BY lot_no DESC LIMIT 1";
...
$refCheckSql = "SELECT reference_no FROM delivery_form_new
