...
try {
    ...
    $sql = "UPDATE assembly_list 
        SET good = :good, not_good = :not_good, 
            ...
            curr_section = 'ASSEMBLY', person_incharge_qc = :qc_name,rework=:rework,`replace`=:replace,timeout_qc=:timeout_qc
        WHERE id = :id";
...
$db->Update($sql, $params);
    ...
    $sqlInsert = "INSERT INTO fg_warehouse (
...
// Step 3: Update material_inventory quantity by adding only the good quantity
    ...
    $sqlUpdate = "UPDATE assembly_list 
                SET good = :good, not_good = :not_good, 
                    status_qc = 'done', 
                    curr_section = 'WAREHOUSE', person_incharge_qc = :qc_name,timeout_qc=:timeout_qc
                WHERE id = :id";
    ...
    $db->Update($sqlInsert, $paramsInsert);
// Step 3: Update material_inventory quantity by adding total_qty
